...
@section('title', 'Админка Услуги | Создание')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Создать услугу</div>
					<div class="pl-3">
...
<div class="card radius-15">
	<div class="card-body">
		...
		@if(true)
		<form action="{{ route('dashboard.cources.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
				...
				<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation"> <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Создать услугу</a>
					</li>
				...
				<div class="tab-content" id="pills-tabContent">
					...
					<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
						...
						<div class="mb-3">
							...
							<input class="form-control @error('name_spiker') error_line @enderror" id="name_spiker" name="name_spiker" type="text" placeholder="" value="{{ old('name_spiker') }}">
							@error('name_spiker')
								<p class="mistake">{{ $message }}</p>
							@enderror
						</div>
						...
						<div class="mb-3">
							...
							<input class="form-control @error('subtitle_spiker') error_line @enderror" id="subtitle_spiker" name="subtitle_spiker" type="text" placeholder="" value="{{ old('subtitle_spiker') }}">
						...
						<div class="mb-3">
							...
							@enderror
							<textarea id="text_spiker" name="text_spiker" class="form-control" rows="10" cols="3">{{ old('text_spiker') }}</textarea>
						</div>
						...
						<div class="mt-4">
							<img id="showAvatar" style="width: 200px; margin-bottom:30px;" src="{{ asset('uploads/not_image.jpg') }}" alt="">
						</div>

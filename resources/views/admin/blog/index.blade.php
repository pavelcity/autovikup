...
<div class="row">
	<div class="col-12">
		<div class="create_button_wrap">
			<h3>Блог </h3>
			<a href="{{ route('dashboard.blog.create') }}" class="btn btn-outline-info m-1 px-5 radius-30">Создать</a>
		</div>
	</div>
</div>
<br>
					...
					<tr>
						...
						<td>
							<div class="btn-group m-1" role="group" aria-label="Basic example">
								<a href="{{ route('dashboard.blog.edit', $blog->id) }}" type="button" class="btn btn-sm btn-info">редактировать</a>
								<a href="{{ route('dashboard.blog.delete', $blog->id) }}" onclick="return confirm('удалить?')" type="button" class="btn btn-sm btn-outline-danger">удалить</a>
							</div>
						</td>
					</tr>
					@endforeach

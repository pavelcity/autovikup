		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Редактировать запись</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Редактировать запись</li>
							</ol>
						</nav>
					</div>
				</div>
		...
		<form action="{{ route('dashboard.blog.update', $blog->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
				...
				<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					<li class="nav-item" role="presentation"> <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Редактировать запись</a>
					</li>
				...
				<div class="tab-content" id="pills-tabContent">
					<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
						...
						<div class="mt-4">
							<img id="showPic" style="width: 400px; margin-bottom:30px;" src="{{ asset($blog->pic ??'uploads/not_image.jpg') }}" alt="">
						</div>
						...
						<div class="mb-3">
							...
							<input class="form-control @error('title') error_line @enderror" id="title" name="title" type="text" placeholder="" value="{{ $blog->title }}">
							@error('title')
					...
					<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
						<div class="mb-3">
							...
							<input class="form-control @error('title') error_line @enderror" id="metatitle" name="metatitle" type="text" placeholder="" value="{{ $blog->metatitle }}">
							@error('metatitle')
								<p class="mistake">{{ $message }}</p>
							@enderror
						</div>
						...
						<div class="mb-5">
							...
							@error('metadescr')
								<p class="mistake">{{ $message }}</p>
							@enderror
							<textarea id="metadescr" name="metadescr" class="form-control" rows="4" cols="3">{{ $blog->metadescr }}</textarea>
						</div>
						...
						<div class="mb-5">
							...
							@error('metakeys')
								<p class="mistake">{{ $message }}</p>
							@enderror
							<textarea id="metakeys" name="metakeys" class="form-control" rows="4" cols="3">{{ $blog->metakeys }}</textarea>
						</div>
					</div>

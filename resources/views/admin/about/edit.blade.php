...
@section('title', 'О нас | Редактировать')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">О нас Редактировать</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">О нас Редактировать</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('dashboard.about.update', $about->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			...
			<input type="hidden" name="old_pic" value="{{ $about->pic }}">
		
			<div class="mt-4">
				<img id="showPic" style="width: 400px; margin-bottom:30px;" src="{{ asset($about->pic ?? 'uploads/not_image.jpg') }}" alt="">
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('name') error_line @enderror" id="name" name="name" type="text" placeholder="" value="{{ $about->name }}">
				@error('name')
			...
			<div class="mb-5">
				...
				<input class="form-control @error('subtitle') error_line @enderror" id="subtitle" name="subtitle" type="text" placeholder="" value="{{ $about->subtitle }}">
				@error('subtitle')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="mb-5">
				...
				@error('shortonhome')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="shortonhome" name="shortonhome" class="form-control" rows="10" cols="3">{{ $about->shortonhome }}</textarea>
			</div>
			...
			<div class="mb-5">
				...
				@error('descronaboutpage')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="descronaboutpage" name="descronaboutpage" class="form-control" rows="10" cols="3">{{ $about->descronaboutpage }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('fichaone') error_line @enderror" id="fichaone" name="fichaone" type="text" placeholder="" value="{{ $about->fichaone }}">
				@error('fichaone')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="mb-5">
				...
				@error('fichaonetext')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="fichaonetext" name="fichaonetext" class="form-control" rows="10" cols="3">{{ $about->fichaonetext }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('fichatwo') error_line @enderror" id="fichatwo" name="fichatwo" type="text" placeholder="" value="{{ $about->fichatwo }}">
				@error('fichatwo')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="mb-5">
				...
				@error('fichatwotext')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="fichatwotext" name="fichatwotext" class="form-control" rows="10" cols="3">{{ $about->fichatwotext }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('fichatri') error_line @enderror" id="fichatri" name="fichatri" type="text" placeholder="" value="{{ $about->fichatri }}">
				@error('fichatri')
					<p class="mistake">{{ $message }}</p>
				@enderror
			</div>
			...
			<div class="mb-5">
				...
				@error('fichatritext')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="fichatritext" name="fichatritext" class="form-control" rows="10" cols="3">{{ $about->fichatritext }}</textarea>
			</div>

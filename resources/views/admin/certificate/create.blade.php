...
@section('title', 'Сертификаты | Создать')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Сертификаты создать</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page"><a href="{{ route('dashboard.certificaty.home') }}">Сертификаты</a></li>
								<li class="breadcrumb-item active" aria-current="page">Сертификаты создать</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="row">
	<div class="col-12">
		<div style="display: flex; justify-content:space-between; align-items:center;">
			<h3>Сертификаты/Дипломы создать</h3>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('dashboard.certificaty.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf

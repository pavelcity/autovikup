...
@section('title', 'Товары | Редактировать')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Редактировать товар</div>
					<div class="pl-3">
...
<div class="card radius-15">
	<div class="card-body">
		...
		@if(true)
		<form action="{{ route('dashboard.tovary.update', $tovar->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
				...
				<div class="tab-content" id="pills-tabContent">
					...
					<div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
						...
						<div class="mb-3">
							...
							<input class="form-control @error('title') error_line @enderror" id="title" name="title" type="text" placeholder="" value="{{ $tovar->title }}">
							@error('title')
						...
						<div class="mb-3">
							...
							<input class="form-control @error('price') error_line @enderror" id="price" name="price" type="text" placeholder="" value="{{ $tovar->price }}">
							@error('price')
								<p class="mistake">{{ $message }}</p>
							@enderror
						</div>
						...
						<div class="mb-3">
							...
							<input class="form-control @error('brand') error_line @enderror" id="brand" name="brand" type="text" placeholder="" value="{{ $tovar->brand }}">
							@error('brand')
								<p class="mistake">{{ $message }}</p>
							@enderror
						</div>
						...
						<div class="mb-5">
							...
							@error('descr')
								<p class="mistake">{{ $message }}</p>
							@enderror
							<textarea id="descr" name="descr" class="form-control" rows="10" cols="3">{{ $tovar->descr }}</textarea>
						</div>
						...
						<input type="hidden" name="old_pic" value="{{ $tovar->pic }}">
			
						<div class="mt-4">
							<img id="showPic" style="width: 400px; margin-bottom:30px;" src="{{ asset($tovar->pic ?? 'uploads/not_image.jpg') }}" alt="">
						</div>
					...
					<div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
						...
						<div class="mb-3">
							...
							<input class="form-control @error('title') error_line @enderror" id="metatitle" name="metatitle" type="text" placeholder="" value="{{ $tovar->metatitle }}">
							@error('metatitle')
								<p class="mistake">{{ $message }}</p>
							@enderror
						</div>
						...
						<div class="mb-5">
							...
							@error('metadescr')
								<p class="mistake">{{ $message }}</p>
							@enderror
							<textarea id="metadescr" name="metadescr" class="form-control" rows="4" cols="3">{{ $tovar->metadescr }}</textarea>
						</div>
						...
						<div class="mb-5">
							...
							@error('metakeys')
								<p class="mistake">{{ $message }}</p>
							@enderror
							<textarea id="metakeys" name="metakeys" class="form-control" rows="4" cols="3">{{ $tovar->metakeys }}</textarea>
						</div>

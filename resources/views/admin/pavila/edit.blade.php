		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Правила Редактировать</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Правила Редактировать</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15 pravilaWrap">
	<div class="card-body">
		...
		<form action="{{ route('dashboard.pravila.update', $pravila->id) }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
			...
			<div class="mb-5">
				...
				@enderror
				<textarea id="politics" name="politics" class="form-control" rows="20" cols="3">{{ $pravila->politics }}</textarea>
			</div>
...
@if(false)
			<div class="mb-5">
				...
				@error('oplata')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="oplata" name="oplata" class="form-control" rows="10" cols="3">{{ $pravila->oplata }}</textarea>
			</div>
			...
			<div class="mb-5">
				...
				@error('vozvrat')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="vozvrat" name="vozvrat" class="form-control" rows="10" cols="3">{{ $pravila->vozvrat }}</textarea>
			</div>
@endif

...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('dashboard.metric.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
			...
			<div class="mb-3">
				...
				@enderror
				<textarea id="googleanalitics" name="googleanalitics" class="form-control" rows="7" cols="3">{{ old('googleanalitics') }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				@error('yandexmetrika')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="yandexmetrika" name="yandexmetrika" class="form-control" rows="7" cols="3">{{ old('yandexmetrika') }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				@error('yandexmap')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="yandexmap" name="yandexmap" class="form-control" rows="5" cols="3">{{ old('yandexmap') }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				@error('fbpixel')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="fbpixel" name="fbpixel" class="form-control" rows="7" cols="3">{{ old('fbpixel') }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				@error('vkpixel')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="vkpixel" name="vkpixel" class="form-control" rows="7" cols="3">{{ old('vkpixel') }}</textarea>
			</div>

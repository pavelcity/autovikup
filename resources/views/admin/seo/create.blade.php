...
@section('title', 'Сео текст | Создать')
		...
		<div class="card radius-15">
			<div class="card-body">
				<div class="page-breadcrumb d-none d-md-flex align-items-center mb-0">
					<div class="breadcrumb-title pr-3">Создать запись для sео</div>
					<div class="pl-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								...
								<li class="breadcrumb-item active" aria-current="page">Создать запись sео</li>
							</ol>
						</nav>
					</div>
				</div>
...
<div class="card radius-15">
	<div class="card-body">
		...
		<form action="{{ route('dashboard.seo.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
			@csrf
			...
			<div class="mb-3">
				...
				<input class="form-control @error('homepage_title') error_line @enderror" id="homepage_title" name="homepage_title" type="text" placeholder="" value="{{ old('homepage_title') }}">
			...
			<div class="mb-5">
				...
				@error('homepage_txt')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="homepage_txt" name="homepage_txt" class="form-control" rows="10" cols="3">{{ old('homepage_txt') }}</textarea>
			</div>
			...
			<div class="mb-3">
				...
				<input class="form-control @error('courcepage_title') error_line @enderror" id="courcepage_title" name="courcepage_title" type="text" placeholder="" value="{{ old('courcepage_title') }}">
			...
			<div class="mb-5">
				...
				@error('courcepage_txt')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="courcepage_txt" name="courcepage_txt" class="form-control" rows="10" cols="3">{{ old('courcepage_txt') }}</textarea>
			</div>
...
@if(false)
			...
			<div class="mb-3">
				...
				<input class="form-control @error('tovarypage_title') error_line @enderror" id="tovarypage_title" name="tovarypage_title" type="text" placeholder="" value="{{ old('tovarypage_title') }}">
			...
			<div class="mb-5">
				...
				@error('tovarypage_txt')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="tovarypage_txt" name="tovarypage_txt" class="form-control" rows="10" cols="3">{{ old('tovarypage_txt') }}</textarea>
			</div>
@endif
			...
			<div class="mb-3">
				...
				<input class="form-control @error('blogpage_title') error_line @enderror" id="blogpage_title" name="blogpage_title" type="text" placeholder="" value="{{ old('blogpage_title') }}">
			...
			<div class="mb-5">
				...
				@error('blogpage_txt')
					<p class="mistake">{{ $message }}</p>
				@enderror
				<textarea id="blogpage_txt" name="blogpage_txt" class="form-control" rows="10" cols="3">{{ old('blogpage_txt') }}</textarea>
			</div>
